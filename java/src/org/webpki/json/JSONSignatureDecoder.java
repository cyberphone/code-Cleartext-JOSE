...
public class JSONSignatureDecoder implements Serializable {
    ...
    JSONSignatureDecoder(JSONObjectReader signedData,
        ...
        signatureValue = innerSignatureObject.getBinary(JSONCryptoHelper.SIGNATURE_JSON);
        ...
        innerSignatureObject.root.properties.remove(JSONCryptoHelper.SIGNATURE_JSON);       //
        //                                                                                  //
