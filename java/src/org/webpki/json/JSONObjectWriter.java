...
public class JSONObjectWriter implements Serializable {
    ...
    private void coreSign(JSONSigner signer, 
        ...
        signatureWriter.setBinary(JSONCryptoHelper.SIGNATURE_JSON,
...
<pre>
    ...
    */
    public JSONObjectWriter setSignature(JSONSigner signer) throws IOException {
        return setSignature(JSONCryptoHelper.SIGNATURE_LABEL_JSON, signer);
    }
    ...
    public JSONObjectWriter setMultiSignature(JSONSigner.MultiSignatureHeader multiSignatureHeader, 
        ...
        return setMultiSignature(JSONCryptoHelper.SIGNATURE_LABEL_JSON, multiSignatureHeader, signer);
    }
